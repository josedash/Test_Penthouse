...
public class DriverFactory {
    ...
    private static final Supplier<WebDriver> mobileChromeSupplier =()->{
        System.setProperty("webdriver.chrome.driver","src\\\\test\\\\resources\\\\webdrivers\\\\chromedriver.exe");
        return new ChromeDriver(BrowserCapabilities.getMobileChromeCapabilities());
    };
    ...
    static {
        ...
        BROWSERS.put("mobilechrome", mobileChromeSupplier);
    ...
    public static WebDriver getMobileChrome(){
        return BROWSERS.get("mobilechrome").get();
    }
